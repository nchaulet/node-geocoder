    ...
    describe('GoogleGeocoder', function() {
        ...
        describe('#geocode' , function() {
            ...
            it('Should return geocoded address', function(done) {
                ...
                googleAdapter.geocode('1 champs élysées Paris', function(err, results, rawResults) {
                    ...
                    rawResults.should.deep.equal({ status: "OK", results: [{
                        geometry: {location : {
                            lat: 37.386,
                            lng: -122.0838
                        }},
            ...
            it('Should handle a not "OK" status', function(done) {
                ...
                googleAdapter.geocode('1 champs élysées Paris', function(err, results, rawResults) {
                    ...
                    rawResults.should.deep.equal({ status: "OVER_QUERY_LIMIT", error_message: "You have exceeded your rate-limit for this API.", results: [] });
        ...
        describe('#reverse' , function() {
            ...
            it('Should return geocoded address', function(done) {
                ...
                var googleAdapter = new GoogleGeocoder(mockedHttpAdapter);
                googleAdapter.reverse(40.714232,-73.9612889, function(err, results, rawResults) {
                        err.should.to.equal(false);
                        results[0].should.to.deep.equal({
                            "latitude"    : 40.714232,
