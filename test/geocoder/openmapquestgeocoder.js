    ...
    describe('MapQuestGeocoder', function() {
        ...
        describe('#constructor' , function() {
            ...
            it('an apiKey must be set', function() {
                ...
                expect(function() {new MapQuestGeocoder(mockedHttpAdapter);}).to.throw(Error, 'OpenMapQuestGeocoder need an apiKey');
            });
        ...
        describe('#geocode' , function() {
            ...
            it('Should not accept Ipv4', function() {
                ...
                }).to.throw(Error, 'OpenMapQuestGeocoder no suport geocoding IPv4');
            ...
            it('Should not accept Ipv6', function() {
                ...
                }).to.throw(Error, 'OpenMapQuestGeocoder no suport geocoding IPv6');
