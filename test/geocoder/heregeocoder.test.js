(function () {
  ...
  describe('HereGeocoder', () => {
    ...
    describe('#constructor', () => {
      ...
      test('requires apiKey to be specified', () => {
        expect(function () { new HereGeocoder(mockedHttpAdapter, {}); }).to.throw(Error, 'You must specify apiKey to use Here Geocoder');
      });

      test(
        'Should be an instance of HereGeocoder if an http adapter and apiKey are provided',
        () => {
          var hereAdapter = new HereGeocoder(mockedHttpAdapter, { apiKey: 'API_KEY' });
    ...
    describe('#geocode', () => {
      ...
      test('Should call httpAdapter get method', () => {
        ...
        mock.expects('get').withArgs('https://geocoder.ls.hereapi.com/6.2/geocode.json', {
      ...
      test(
        ...
        () => {
          ...
          var hereAdapter = new HereGeocoder(mockedHttpAdapter, { apiKey: 'API_KEY', language: 'en' });
      ...
      test(
        ...
        () => {
          ...
          var hereAdapter = new HereGeocoder(mockedHttpAdapter, { apiKey: 'API_KEY', politicalView: 'GRE' });
      ...
      test(
        ...
        () => {
          ...
          var hereAdapter = new HereGeocoder(mockedHttpAdapter, { apiKey: 'API_KEY', country: 'FR' });
      ...
      test('Should call httpAdapter get method with state if specified', () => {
        ...
        var hereAdapter = new HereGeocoder(mockedHttpAdapter, { apiKey: 'API_KEY', state: 'Île-de-France' });
      ...
      test(
        ...
        () => {
          ...
          var hereAdapter = new HereGeocoder(mockedHttpAdapter, { apiKey: 'API_KEY', country: 'FR', state: 'Île-de-France' });
      ...
      test('Should handle a not "OK" status', done => {
        ...
        mock.expects('get').once().callsArgWith(2, new Error('Response status code is 401'), {
          details: 'invalid credentials for API_KEY',
          additionalData: [],
    ...
    describe('#reverse', () => {
      ...
      //     it('Should call httpAdapter get method with signed url if apiKey specified', function() {
      //         var mock = sinon.mock(mockedHttpAdapter);
      ...
      //         var hereAdapter = new HereGeocoder(mockedHttpAdapter, {apiKey: 'raoul', appCode: 'foo'});
      ...
      //         var hereAdapter = new HereGeocoder(mockedHttpAdapter, {apiKey: 'james', appCode: 'foo'});
      //         var params = {
      //           sensor: false,
      //           client: 'james',
      //           address:  'qqslfzxytfr'
