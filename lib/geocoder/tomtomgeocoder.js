...
TomTomGeocoder.prototype._geocode = function(value, callback) {
  ...
  var countryParam = this.options.country
  if (countryParam && typeof countryParam === 'string' && countryParam.match(/^[a-zA-Z]{2}$/)) {
    params.countrySet = this.options.country;
  } else {
    throw new Error('The country param has an unsupported format');
  }
