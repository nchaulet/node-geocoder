...
LocationIQGeocoder.prototype._formatResult = function(result) {
  ...
  if (result.address) {
    /* make sure country name is unified accross geocoders */
    transformedResult.country = result.address.country === 'United States of America' ? 'United States' : result.address.country;
