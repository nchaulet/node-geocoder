...
var GoogleGeocoder = function(httpAdapter, options) {
    ...
    if (!this.options.language || this.options.language == 'undefinded') {
    ...
    if (!this.options.clientId || this.options.clientId == 'undefinded') {
...
GoogleGeocoder.prototype.name = 'GoogleGeocoder';
