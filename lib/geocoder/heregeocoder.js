 ...
 * @param <object> options     Options (apiKey, language, politicalView, country, state, production)
 */
var HereGeocoder = function HereGeocoder(httpAdapter, options) {
  this.options = ['apiKey', 'language', 'politicalView', 'country', 'state', 'production'];
