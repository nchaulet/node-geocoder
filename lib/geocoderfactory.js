		...
		*/
		_getGeocoder: function(geocoderName, adapter, extra) {
			if (geocoderName === 'google') {
				...
				return new GoogleGeocoder(adapter, {clientId: extra.clientId, apiKey: extra.apiKey, language: extra.language, region: extra.region, includePlaceId: extra.includePlaceId, includeFormattedAddress: extra.includeFormattedAddress});
			}
