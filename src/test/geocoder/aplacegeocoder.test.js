  ...
  describe('APlaceGeocoder', () => {
    describe('#constructor', () => {
      ...
      test('Should be an instance of APlaceGeocoder', () => {
        var adapter = new APlaceGeocoder(mockedHttpAdapter, {
          apiKey: 'API_KEY'
        });
    ...
    describe('#geocode', () => {
      ...
      test('Should return geocoded address when queried with an object', done => {
        var mock = sinon.mock(mockedHttpAdapter);
        var rawResponse = {
          session_id: '1',
          data: [
    ...
    describe('#reverse', () => {
      test('Should correctly return a result for a reverse search', done => {
        ...
        adapter.reverse(
          { lat: 48.866667, lon: 2.333333 },
          function (err, results) {
            err.should.equal(false);
            // check for empty result
            results.should.be.an('array').have.length.of(1);
            results.should.have.property('raw');
